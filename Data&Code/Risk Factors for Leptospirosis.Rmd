...
```
```{r}
# define a function to compute prevalence in different groups
...
# ANOVA
anova(glmer_v_1, glmer_v_3, glmer_v_4)
```
...
# glmer - village
roc_v <- roc(lep_narm$result, pred_v_1, percent = TRUE, ci = TRUE,
             quiet = TRUE, plot = TRUE, col = "red")
# glmer - location
roc_l <- roc(lep_narm$result, pred_l, percent = TRUE, plot = TRUE, 
             ci = TRUE, quiet = TRUE, add = TRUE, col = "blue")
# glm
roc_glm <- roc(lep_narm$result, glm_selected$fitted.values, percent = TRUE, 
               ci = TRUE, quiet = TRUE, plot = TRUE, add = TRUE, col = "green")
# legends
